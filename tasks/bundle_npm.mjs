...
async function buildEsm() {
    ...
    const entryPoints = {
        ...
        'traces/scattergeo': path.join(constants.pathToSrc, 'traces/scattergeo/index.ts'),
        'traces/choropleth': path.join(constants.pathToSrc, 'traces/choropleth/index.ts'),
        'traces/scattermapbox': path.join(constants.pathToSrc, 'traces/scattermapbox/index.ts'),
        'traces/scattermap': path.join(constants.pathToSrc, 'traces/scattermap/index.ts'),
        ...
        'traces/heatmap': path.join(constants.pathToSrc, 'traces/heatmap/index.ts'),
        ...
        'traces/parcoords': path.join(constants.pathToSrc, 'traces/parcoords/index.ts'),
        'traces/scattergl': path.join(constants.pathToSrc, 'traces/scattergl/index.ts'),
        'traces/parcats': path.join(constants.pathToSrc, 'traces/parcats/index.ts'),
        'traces/splom': path.join(constants.pathToSrc, 'traces/splom/index.ts'),
        'traces/scatterpolargl': path.join(constants.pathToSrc, 'traces/scatterpolargl/index.ts')
    };
